...
class NotificationsApi {
  ...
  /// Performs an HTTP 'POST /v1/notifications/{id}' operation and returns the [Response].
  /// Parameters:
  ///
  /// * [String] id (required):
  Future<Response> fetchNotificationWithHttpInfo(
    String id,
  ) async {
    // ignore: prefer_const_declarations
    final path = r'/v1/notifications/{id}'.replaceAll('{id}', id);
  ...
  Future<Response> fetchNotificationsWithHttpInfo() async {
    // ignore: prefer_const_declarations
