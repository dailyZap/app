...
class Content {
  ...
  bool operator ==(Object other) =>
      ...
      other is Content &&
          other.userId == userId &&
          _deepEquality.equals(other.zaps, zaps);

  @override
  int get hashCode =>
      // ignore: unnecessary_parenthesis
      (userId.hashCode) + (zaps.hashCode);

  @override
  String toString() => 'Content[userId=$userId, zaps=$zaps]';

  Map<String, dynamic> toJson() {
    final json = <String, dynamic>{};
    json[r'userId'] = this.userId;
    json[r'zaps'] = this.zaps;
    return json;
  }
  ...
  static Content? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return Content(
        ...
        zaps: Zap.listFromJson(json[r'zaps']),
      );
    }
    return null;
  }
